...
document.addEventListener('DOMContentLoaded', function () {
  const heroSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.hero__swiper', {
    slidesPerView: 1,
    effect: 'fade',
    fadeEffect: {
      crossFade: true
    ...
    pagination: {
      el: '.hero__swiper_pagination'
    },
    on: {
      slideChange: function (swiper) {
        const currentSlide = document.querySelector('.hero__swiper_counter span');
        currentSlide.innerHTML = swiper.activeIndex + 1 < 10 ? `0${swiper.activeIndex + 1}` : swiper.activeIndex + 1;
      }
    }
  });
  const ceoSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.ceo-hero__swiper', {
    slidesPerView: 'auto',
    loop: true,
    speed: 700,
    autoplay: {
  ...
  const circleArc = document.getElementById('about__source_arc-text');

  if (circleArc) {
    const circleArcText = new (circletype__WEBPACK_IMPORTED_MODULE_2___default())(document.getElementById('about__source_arc-text')).radius(165);
  }

  const circleArc2 = document.getElementById('about__source_arc-text2');

  if (circleArc2) {
    const circleArcText2 = new (circletype__WEBPACK_IMPORTED_MODULE_2___default())(document.getElementById('about__source_arc-text2')).radius(165);
  }

  const circleArc3 = document.getElementById('production-hero__left_arc-text');

  if (circleArc3) {
    const circleArcText3 = new (circletype__WEBPACK_IMPORTED_MODULE_2___default())(document.getElementById('production-hero__left_arc-text')).radius(195);
  }

  const circleArc4 = document.getElementById('production-hero__right_arc-text');

  if (circleArc4) {
    const circleArcText4 = new (circletype__WEBPACK_IMPORTED_MODULE_2___default())(document.getElementById('production-hero__right_arc-text')).dir(-1).radius(220);
  }

  const circleArc5 = document.getElementById('how__right_text');

  if (circleArc5) {
    const circleArcText5 = new (circletype__WEBPACK_IMPORTED_MODULE_2___default())(document.getElementById('how__right_text')).dir(-1).radius(220);
  } // ---------------------------------------------------------


  const menuBurger = document.querySelector('.header__burger');
  const navItem = document.querySelectorAll('.nav__link');
  const menuBody = document.querySelector('.header .nav-left');

  if (menuBurger) {
    menuBurger.addEventListener('click', function (e) {
      document.body.classList.toggle('_lock');
      menuBurger.classList.toggle('_active');
      menuBody.classList.toggle('header__nav_active'); // headerScrool.classList.toggle('header__content_active')
    });
